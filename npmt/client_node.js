...
var data = {
  'login[username]':"zhangcy26s9",
  'login[password]':"227031zcy",
   'send':''
}
 var headers = {
...
needle.post('https://www.adidas.com.cn/customer/account/loginPost/', data, {headers: headers,multipart: true }, 
	function(err, resp, body) {
  	console.log(resp);
 //  	fs.writeFile('bb1.html', resp.text, function (err) {
 //    	if (err) throw err;
